...
const DashboardHome = () => {
  return (
    <div className='min-h-screen bg-gradient-to-br from-amber-50 to-indigo-300 p-8'>
      <div className='max-w-6xl mx-auto bg-white rounded-2xl shadow-lg p-8 space-y-8'>
        ...
        <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8'>
          ...
          className='bg-blue-100 hover:bg-blue-200 p-6 rpunded-xl shadow-md hover:shadow-xl transition-all duration-200 ease-in-out transform hover:scale-105'>
